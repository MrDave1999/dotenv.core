...
**Suggestion:** It is recommended to use constants to avoid the use of hard-coded keys in the source code. A complete example can be found [here](https://github.com/MrDave1999/dotenv.core/blob/master/example/Program.cs).
