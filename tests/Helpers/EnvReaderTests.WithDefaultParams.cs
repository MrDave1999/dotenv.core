...
namespace DotEnv.Core.Tests.Helpers
{
    ...
    public class EnvReaderWithDefaultParamsTests
    {
        ...
        [TestMethod]
        public void EnvChar_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
        ...
        [TestMethod]
        public void EnvDecimal_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
        ...
        [TestMethod]
        public void EnvDouble_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
        ...
        [TestMethod]
        public void EnvFloat_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
        ...
        [TestMethod]
        public void EnvInt_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
        ...
        [TestMethod]
        public void EnvLong_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
        ...
        [TestMethod]
        public void EnvSByte_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
        ...
        [TestMethod]
        public void EnvShort_WhenTheVariableIsFound_ShouldReturnValue()
        {
            var reader = new EnvReader();
